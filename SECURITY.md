...
Seneschal is designed for local use and binds to `127.0.0.1`. Do not change it to `0.0.0.0`, forward its ports, or expose it through a tunnel without adding proper authentication and reviewing the threat model.
